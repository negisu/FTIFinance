...
Public Class frmFTImemberStatus
    ...
    Private Sub getMB_MEMBER_RETIRE(ByVal FROM_DATE As Date, ByVal TO_DATE As Date)
        ...
        query &= "                         MB_MEMBER.MEMBER_CODE, MB_MEMBER.REGIST_DATE, MB_MEMBER_RETIRE.APPROVE_DATE, MB_MEMBER.MEMBER_STATUS_CODE, MB_MEMBER.COMP_PERSON_CODE, "
        query &= "                         MB_PRENAME.PRENAME_TH, MB_COMP_PERSON.COMP_PERSON_NAME_TH, MB_PRENAME.PRENAME_EN, MB_COMP_PERSON.COMP_PERSON_NAME_EN, MB_COMP_PERSON_ADDRESS.ADDR_NO, "
        ...
        query &= "                         MB_PRENAME_1.PRENAME_TH AS CONTACT_PRENAME_TH, MB_CONTACT.CONTACT_FIRST_NAME_TH, MB_CONTACT.CONTACT_LAST_NAME_TH, "
        ...
        query &= "                         MB_MEMBER_1.MEMBER_CODE AS MEMBER_CODE_OLD, MB_MEMBER_TYPE_1.MEMBER_TYPE_NAME AS MEMBER_TYPE_NAME_OLD "
        ...
        query &= "                         MB_MEMBER.MEMBER_TYPE_CODE = MB_MEMBER_TYPE.MEMBER_TYPE_CODE INNER JOIN "
        query &= "                         MB_MEMBER_RETIRE ON MB_MEMBER.MEMBER_CODE = MB_MEMBER_RETIRE.MEMBER_CODE INNER JOIN "
        query &= "                         MB_MEMBER AS MB_MEMBER_1 ON MB_MEMBER_RETIRE.REGIST_CODE = MB_MEMBER_1.REGIST_CODE INNER JOIN "
        query &= "                         MB_MEMBER_TYPE AS MB_MEMBER_TYPE_1 ON MB_MEMBER_1.MEMBER_MAIN_GROUP_CODE = MB_MEMBER_TYPE_1.MEMBER_MAIN_GROUP_CODE AND "
        query &= "                         MB_MEMBER_1.MEMBER_GROUP_CODE = MB_MEMBER_TYPE_1.MEMBER_GROUP_CODE AND MB_MEMBER_1.MEMBER_MAIN_TYPE_CODE = MB_MEMBER_TYPE_1.MEMBER_MAIN_TYPE_CODE AND "
        query &= "                         MB_MEMBER_1.MEMBER_TYPE_CODE = MB_MEMBER_TYPE_1.MEMBER_TYPE_CODE "
        query &= "WHERE        (MB_COMP_PERSON_ADDRESS.ADDR_CODE = '001') AND (MB_MEMBER_REPRESENT.REPRESENT_SEQ = 1) AND (MB_PRENAME_1.PRENAME_TYPE = 1) AND (MB_PRENAME.PRENAME_TYPE = 2) AND "
        query &= "                         (MB_MEMBER.MEMBER_MAIN_GROUP_CODE IN ('000', '100', '200', '999')) AND (MB_MEMBER.MEMBER_CODE IN "
        query &= "                             (SELECT        MEMBER_CODE "
        query &= "                               FROM            MB_MEMBER_RETIRE AS MB_MEMBER_RETIRE_1 "
        query &= "                               WHERE        (APPROVE_DATE BETWEEN @p0 AND @p1) AND (RETIRE_TYPE = 'T') AND (MEMBER_MAIN_GROUP_CODE IN ('000', '100', '200', '999')))) "
        ...
        Else
            ...
            'DataGridView1.Columns("APPROVE_DATE").Visible = True
            DataGridView1.Columns("MEMBER_CODE_OLD").Visible = True
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btPrintPreview.Click
        If DataGridView1.CurrentRow IsNot Nothing Then
            ...
            If fi.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                ...
                f.ReportViewer1.LocalReport.ReportPath = System.Environment.CurrentDirectory & "/Reports/module1/rdlc5.3.25.01.FTImemberStatusChanged.rdlc"
                ...
                PRENAME.Values.Add(DataGridView1.CurrentRow.Cells("PRENAME_TH").Value.ToString)

                Dim CONTACT_FIRST_NAME As New ReportParameter()
                CONTACT_FIRST_NAME.Name = "CONTACT_FIRST_NAME"
                CONTACT_FIRST_NAME.Values.Add(DataGridView1.CurrentRow.Cells("CONTACT_FIRST_NAME_TH").Value.ToString)

                Dim CONTACT_LAST_NAME As New ReportParameter()
                CONTACT_LAST_NAME.Name = "CONTACT_LAST_NAME"
                CONTACT_LAST_NAME.Values.Add(DataGridView1.CurrentRow.Cells("CONTACT_LAST_NAME_TH").Value.ToString)

                Dim COMP_PERSON_NAME As New ReportParameter()
                COMP_PERSON_NAME.Name = "COMP_PERSON_NAME"
                COMP_PERSON_NAME.Values.Add(DataGridView1.CurrentRow.Cells("COMP_PERSON_NAME_TH").Value.ToString)
                ...
                CONTACT_PRENAME.Values.Add(DataGridView1.CurrentRow.Cells("CONTACT_PRENAME_TH").Value.ToString)

                Dim MEMBER_CODE_OLD As New ReportParameter()
                MEMBER_CODE_OLD.Name = "MEMBER_CODE_OLD"
                MEMBER_CODE_OLD.Values.Add(DataGridView1.CurrentRow.Cells("MEMBER_CODE_OLD").Value.ToString)

                Dim MEMBER_TYPE_NAME_OLD As New ReportParameter()
                MEMBER_TYPE_NAME_OLD.Name = "MEMBER_TYPE_NAME_OLD"
                MEMBER_TYPE_NAME_OLD.Values.Add(DataGridView1.CurrentRow.Cells("MEMBER_TYPE_NAME_OLD").Value.ToString)

                'Set the report parameters for the report
                Dim params() As ReportParameter = {DOC_NO, MEMBER_CODE, ADDR_NO, ADDR_MOO, ADDR_SOI, ADDR_ROAD, ADDR_SUB_DISTRICT, ADDR_DISTRICT, ADDR_PROVINCE_NAME, ADDR_POSTCODE, APPROVE_DATE, MANAGER_NAME, MANAGER_DESIGNATION, DOC_USER_NAME, DOC_USER_TEL, DOC_DATE, PRENAME, CONTACT_FIRST_NAME, CONTACT_LAST_NAME, COMP_PERSON_NAME, MEMBER_TYPE_NAME, CONTACT_PRENAME, MEMBER_CODE_OLD, MEMBER_TYPE_NAME_OLD}
