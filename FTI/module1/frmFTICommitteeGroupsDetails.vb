Public Class frmFTICommitteeGroupsDetails
    ...
    Private Sub btContacts_Click(sender As Object, e As EventArgs) Handles btContacts.Click
        If DataGridView1.CurrentRow IsNot Nothing Then
            Dim f As New frmMainContacts
            If f.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                If MessageBox.Show("ยืนยันที่จะ" & btContacts.Text & "?", "ยืนยัน?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    Dim parameters As New Dictionary(Of String, Object)
                    Dim query As String = String.Empty
