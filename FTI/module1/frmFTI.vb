...
Public Class frmFTI
    ...
    Private Sub frmFTI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        query &= "WHERE        (MB_MEMBER.MEMBER_MAIN_GROUP_CODE IN (@p0, @p1, @p2, @p3)) AND (MB_MEMBER.RETIRE_DATE IS NOT NULL) "
        ...
        'predefine fields
        Dim FTI_MAIN_SEARCH_PRE As String = getParameters(1, "FTI_MAIN_SEARCH_PRE")

        'search as thai text
        Dim FTI_MAIN_SEARCH As String = getParameters(1, "FTI_MAIN_SEARCH")
    ...
    Private Sub getMEMBER(Optional ByVal REGIST_CODE As String = "")
        ...
        query &= "WHERE        (MB_MEMBER.MEMBER_MAIN_GROUP_CODE IN (@p0, @p1, @p2, @p3)) AND (LEN(MB_MEMBER.REGIST_CODE) > 0) "
    ...
    Private Sub getMEMBER_MAIN_GROUP()
        ...
        query &= "WHERE (MEMBER_MAIN_GROUP_CODE IN (@p0,@p1,@p2,@p3)) AND (INACTIVE <> 1) "
    ...
    Private Sub getMB_MEMBER_ADVISOR()
        ...
        sFTI_MB_MEMBER_ADVISOR &= "WHERE " & getParameters(1, "FTI_MB_MEMBER_ADVISOR") & " ORDER BY MEMBER_GROUP_NAME"
    ...
    Private Sub getMB_MEMBER_STATUS()
        ...
        Dim query As String = String.Empty
        query &= "SELECT * FROM MB_MEMBER_STATUS WHERE MODULE = 1 ORDER BY MEMBER_STATUS_CODE"
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        ...
        If DataGridView1.CurrentRow IsNot Nothing Then
            ...
            query &= "WHERE (MEMBER_MAIN_GROUP_CODE = @p0) AND (MEMBER_GROUP_CODE = @p1) AND (MEMBER_MAIN_TYPE_CODE = @p2) AND (MEMBER_TYPE_CODE = @p3) AND (INACTIVE = 0) "
    ...
    Private Sub btMemberGroupAdd_Click(sender As Object, e As EventArgs) Handles btMemberGroupAdd.Click
        System.Windows.Forms.Cursor.Current = Cursors.WaitCursor
        If DataGridView1.CurrentRow IsNot Nothing Then
            Dim sFTI_STATUS_GROUP_ADD() As String = getParameters(1, "FTI_STATUS_GROUP_ADD").Split("|"c)
            If IsExistStatus(sFTI_STATUS_GROUP_ADD(0), ComboBox13.SelectedValue.ToString) = True And ComboBox3.SelectedValue.ToString = "000" And tbMEMBER_CODE.Text <> "<AUTO>" Then
                Dim f As New frmFTIMemberGroupAdd
                f.TextBox2.Text = TextBox2.Text
                f.TextBox21.Text = tbMEMBER_CODE.Text
                f.TextBox22.Text = tbREGIST_CODE.Text
                f.TextBox4.Text = TextBox4.Text
                f.TextBox1.Text = ComboBox13.Text
                f.MEMBER_MAIN_GROUP = tbMEMBER_MAIN_GROUP.Text
                f.MEMBER_GROUP = tbMEMBER_GROUP.Text
                f.MEMBER_MAIN_TYPE = tbMEMBER_MAIN_TYPE.Text
                f.MEMBER_TYPE = tbMEMBER_TYPE.Text
                ...
                If f.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                    ...
                    parameters.Add("@p1", f.ComboBox3.SelectedValue) '1
                    parameters.Add("@p2", f.ComboBox4.SelectedValue) '2
                    parameters.Add("@p3", f.ComboBox14.SelectedValue) '3
                    parameters.Add("@p4", f.ComboBox15.SelectedValue) '4
                    parameters.Add("@p", f.TextBox22.Text) 'old regist code
                    ...
                    query &= "                         @p4 AS MEMBER_TYPE_CODE, MEMBER_CODE, GETDATE() AS REGIST_DATE, NULL AS MEMBER_DATE, RETIRE_DATE, NULL AS APPROVE_RETIRE_DATE, "
                    query &= "                         COMMITTION_AMNT, PROG_ID, CR_BY, CR_DATE, UPD_BY, UPD_DATE, '" & sFTI_STATUS_GROUP_ADD(1) & "' AS MEMBER_STATUS_CODE, COMP_PERSON_CODE, STATUS_TYPE, OLD_REGIST_CODE, "
                    ...
                    parameters.Add("@p", f.TextBox22.Text)
                ...
                f = Nothing
            Else
                MessageBox.Show("กรุณาเลือกสมาชิกที่ กลุ่มหลัก/กลุ่ม เป็น สภาอุตสาหกรรม และมีสถานะ " & sFTI_STATUS_GROUP_ADD(0))
            End If
        End If
    ...
    Private Sub btResign_Click(sender As Object, e As EventArgs) Handles btResign.Click
        ...
        If DataGridView1.CurrentRow IsNot Nothing Then
            ...
            If IsExistStatus(sFTI_STATUS_RESIGN(0), ComboBox13.SelectedValue.ToString) = True And tbMEMBER_CODE.Text <> "<AUTO>" Then
                Dim f As New frmFTIStatusResignNew
                f.TextBox1.Text = "C"
    ...
    Private Sub btHold_Click(sender As Object, e As EventArgs) Handles btHold.Click
        System.Windows.Forms.Cursor.Current = Cursors.WaitCursor
        If DataGridView1.CurrentRow IsNot Nothing Then
            Dim sFTI_STATUS_HOLD() As String = getParameters(1, "FTI_STATUS_HOLD").Split("|"c)
    ...
    Private Sub btStatus_Click(sender As Object, e As EventArgs) Handles btStatus.Click
        ...
        If DataGridView1.CurrentRow IsNot Nothing Then
            ...
            If IsExistStatus(sFTI_STATUS_MOVE(0), ComboBox13.SelectedValue.ToString) = True And tbMEMBER_CODE.Text <> "<AUTO>" And DataGridView1.CurrentRow.Cells("MEMBER_MAIN_GROUP_CODE").Value.ToString = "000" Then
                Dim f As New frmFTIStatusResignNew
                f.TextBox1.Text = "T"
                f.TextBox2.Text = sFTI_STATUS_MOVE(1)
                f.REGIST_CODE = tbREGIST_CODE.Text
                f.ds = ds.Copy
                f.MEMBER_MAIN_GROUP_CODE = ComboBox3.SelectedValue.ToString
                f.MEMBER_GROUP_CODE = ComboBox4.SelectedValue.ToString
                f.MEMBER_MAIN_TYPE_CODE = ComboBox14.SelectedValue.ToString
                f.MEMBER_TYPE_CODE = ComboBox15.SelectedValue.ToString

                f.Label4.Visible = False
                f.ComboBox3.Visible = False
                f.Label10.Visible = False
                f.ComboBox4.Visible = False
                ...
                If f.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                    ...
                    'Dim parameters As New Dictionary(Of String, Object)
                    parameters.Clear()
                    parameters.Add("@p0", sFTI_STATUS_MOVE(2).ToUpper)
                    'parameters.Add("@p1", row("MEMBER_MAIN_GROUP_CODE"))
                    'parameters.Add("@p2", row("MEMBER_GROUP_CODE"))
                    'parameters.Add("@p3", row("MEMBER_MAIN_TYPE_CODE"))
                    'parameters.Add("@p4", row("MEMBER_TYPE_CODE"))
                    ...
                    'save it
                    saveLOGS(DataGridView1.CurrentRow.Cells("REGIST_CODE").Value.ToString, "MB_MEMBER", "MEMBER_STATUS_CODE", "UPDATE", tbMEMBER_STATUS_CODE.Text, sFTI_STATUS_MOVE(2).ToUpper, user_name)
                ...
                f = Nothing
            Else
                MessageBox.Show("กรุณาเลือกสมาชิก ส.อ.ท. ที่มีสถานะ " & sFTI_STATUS_MOVE(0))
            End If
        End If
    End Sub
