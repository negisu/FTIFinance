...
Public Class frmFTImemberHold
    ...
    Private Sub getMB_MEMBER_RETIRE(ByVal FROM_DATE As Date, ByVal TO_DATE As Date)
        ...
        query &= "                               WHERE        (APPROVE_DATE BETWEEN @p0 AND @p1) AND (RETIRE_TYPE = 'S') AND (MEMBER_MAIN_GROUP_CODE IN ('000', '100', '200', '999')))) "
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btPrintPreview.Click
        If DataGridView1.CurrentRow IsNot Nothing Then
            ...
            If fi.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                ...
                f.ReportViewer1.LocalReport.ReportPath = System.Environment.CurrentDirectory & "/Reports/module1/rdlc5.3.25.01.FTImemberStatusHold.rdlc"
