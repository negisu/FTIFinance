...
Public Class frmMainFileTypeNew
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        If TextBox9.TextLength > 0 Then
            ...
            qRep &= "FROM MB_MEMBER_FILES_TYPE "
            qRep &= "WHERE (DOC_TYPE_NAME = @p0)"
            ...
            Catch ex As Exception
                MessageBox.Show(qRep & vbCrLf & vbCrLf & ex.Message, "ERROR=client.ExecuteScalar CNT MB_MEMBER_FILES_TYPE")
            End Try
            ...
            If CNT = 0 Then
                ...
                Me.Close()
            Else
                MessageBox.Show("พบ " & TextBox9.Text & " ในฐานข้อมูลอยู่แล้วจำนวน " & CNT & " รายการ")
            End If
        End If
    End Sub
