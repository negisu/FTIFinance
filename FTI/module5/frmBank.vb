Public Class frmBank
    ...
    Private FIELD_BANK_SHNM_ENG As String = "SHNM_ENG"
    Private TABLE_NAME As String = "DB_BANK"
    ...
    Private Sub GetList()
        ...
        If Not String.IsNullOrEmpty(searchValue) Then
            ...
            If cbSearch.SelectedIndex = 2 Then
                qRep &= String.Format(" WHERE (" + FIELD_BANK_SHNM_ENG + " LIKE '%{0}%')", searchValue)
            End If
        End If
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        If txt1.TextLength > 0 And txt2.TextLength > 0 And txt3.TextLength > 0 Then
            ...
            If CNT = 0 Then
                ...
                qRep = String.Empty
                qRep = "INSERT INTO " + TABLE_NAME + " (" + FIELD_BANK_CODE + ", " + FIELD_BANK_NAME + ", " + FIELD_BANK_SHNM_ENG + ") VALUES (@p0,@p1,@p2)"
    ...
    Private Sub btnRemove_Click(sender As Object, e As EventArgs) Handles btnRemove.Click
        If DataGridView1.CurrentRow IsNot Nothing Then
            If MessageBox.Show("ยืนยันที่จะลบ " & DataGridView1.CurrentRow.Cells(FIELD_BANK_CODE).Value.ToString, "ยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                'delete it
                Dim parameters As New Dictionary(Of String, Object)
                parameters.Add("@p0", DataGridView1.CurrentRow.Cells(FIELD_BANK_CODE).Value)

                Dim query As String = "DELETE FROM " + TABLE_NAME + " WHERE " + FIELD_BANK_CODE + " = @p0"
