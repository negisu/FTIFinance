Public Class frmFINCreditType
    ...
    Private TABLE_NAME As String = "PAYMENT_POSITION"

    Private Sub frmFINCreditType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ds = New DataSet
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        If txt1.TextLength > 0 And txt2.TextLength > 0 Then
            ...
            If CNT = 0 Then
                ...
                qRep = String.Empty
                qRep = "INSERT INTO " + TABLE_NAME + " (" + FIELD_CODE + ", " + FIELD_NAME + ") VALUES (@p0,@p1)"
