Public Class frmFINCashier
    ...
    Private FIELD_CODE As String = "PAY_CODE"
    Private FIELD_NAME As String = "PAY_NAME"
    Private FIELD_CONTACT As String = "PAY_CONTACT"
    Private FIELD_POSITION As String = "PAY_POSITION"

    Private TABLE_NAME As String = "CASHIER"

    Private Sub frmFINCashier_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ds = New DataSet
    ...
    Private Sub GetList()
        ...
        If Not String.IsNullOrEmpty(searchValue) Then
            ...
            If cbSearch.SelectedIndex = 2 Then
                qRep &= String.Format(" WHERE (" + FIELD_CONTACT + " LIKE '%{0}%')", searchValue)
            End If
            If cbSearch.SelectedIndex = 3 Then
                qRep &= String.Format(" WHERE (" + FIELD_POSITION + " LIKE '%{0}%')", searchValue)
            End If
        End If
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        If txt1.TextLength > 0 And txt2.TextLength > 0 And txt3.TextLength > 0 And txt4.TextLength > 0 Then
            ...
            If CNT = 0 Then
                ...
                qRep = String.Empty
                qRep = "INSERT INTO " + TABLE_NAME + " (" + FIELD_CODE + ", " + FIELD_NAME + ", " + FIELD_CONTACT + ", " + FIELD_POSITION + ") VALUES (@p0,@p1,@p2,@p3)"
