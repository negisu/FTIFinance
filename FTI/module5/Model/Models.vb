Public Class FIN_PN_IV_HEAD
    ...
    Public COMPLETE_FLAG As String
    ...
    Public COMP_PERSON_NAME_TH As String
    Public COMP_PERSON_NAME_EN As String
    Public PAID_FLAG As String
    Public PAID_DATE As Date
End Class

Public Class FIN_PN_IV_DETAIL
    Public OU_CODE As String
    Public DIV_CODE As String
