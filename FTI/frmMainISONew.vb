...
Public Class frmMainISONew
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        If TextBox9.TextLength > 0 And TextBox30.TextLength > 0 Then
            ...
            qRep &= "FROM MB_ISO "
            qRep &= "WHERE (ISO_DESC_TH = @p0) AND (ISO_DESC_EN = @p1)"
            ...
            Catch ex As Exception
                MessageBox.Show(qRep & vbCrLf & vbCrLf & ex.Message, "ERROR=client.ExecuteScalar CNT MB_ISO")
            End Try
