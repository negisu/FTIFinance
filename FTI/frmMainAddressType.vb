...
Public Class frmMainAddressType
    ...
    Private Sub getMB_PRENAME()
        ...
        query &= "FROM            MB_ADDRESS_TYPE "
        query &= "WHERE        (ADDRESS_TYPE_NAME_TH LIKE @p0) OR "
        query &= "                         (ADDRESS_TYPE_NAME_EN LIKE @p1) "
        query &= "ORDER BY ADDRESS_TYPE_NAME_TH, ADDRESS_TYPE_NAME_EN"

        Dim dt As DataTable = New DataTable

        dt = fillWebSQL(query, parameters, "MB_ADDRESS_TYPE")
        ...
        Else
            ...
            ds.Tables("MB_ADDRESS_TYPE").PrimaryKey = New DataColumn() {ds.Tables("MB_ADDRESS_TYPE").Columns("ADDRESS_TYPE_CODE")}

            DataGridView1.DataSource = ds.Tables("MB_ADDRESS_TYPE")

            For i As Integer = 0 To DataGridView1.ColumnCount - 1
                DataGridView1.Columns(i).Visible = False
            Next
            DataGridView1.Columns("ADDRESS_TYPE_CODE").Visible = True
            ...
            DataGridView1.Columns("ADDRESS_TYPE_NAME_TH").Width = 230
            DataGridView1.Columns("ADDRESS_TYPE_NAME_EN").Width = 230

            DataGridView1.Columns("ADDRESS_TYPE_CODE").ReadOnly = True
        End If
    End Sub
    ...
    Private Sub btApply_Click(sender As Object, e As EventArgs) Handles btApply.Click
        ...
        If DataGridView1.CurrentRow IsNot Nothing Then
            ...
            If MessageBox.Show("ยืนยันที่จะ" & btApply.Text & "?", "ยืนยัน?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Dim row As DataRow = ds.Tables("MB_ADDRESS_TYPE").Rows.Find(DataGridView1.CurrentRow.Cells("ADDRESS_TYPE_CODE").Value)
                ...
                Try
                    ...
                    If ds.Tables("MB_ADDRESS_TYPE").GetChanges IsNot Nothing Then
                        Try
                            updateWebSQL(query, parameters, ds.Tables("MB_ADDRESS_TYPE"))
                        Catch ex As Exception
                ...
                Catch ex As Exception
                    MessageBox.Show(ex.Message, "MB_ADDRESS_TYPE.UPDATE Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End Try
    ...
    Private Sub btNew_Click(sender As Object, e As EventArgs) Handles btNew.Click
        'new contact
        System.Windows.Forms.Cursor.Current = Cursors.WaitCursor
        Dim f As New frmMainAddressTypeNew
        If f.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
            ...
            Dim query As String = "SELECT TOP (1) CONVERT(INT, ADDRESS_TYPE_CODE) AS CNT FROM MB_ADDRESS_TYPE ORDER BY CONVERT(INT, ADDRESS_TYPE_CODE) DESC"
            ...
            query = "INSERT INTO MB_ADDRESS_TYPE (ADDRESS_TYPE_CODE, ADDRESS_TYPE_NAME_TH, ADDRESS_TYPE_NAME_EN) VALUES (@p0,@p1,@p2)"
    ...
    Private Sub btDelete_Click(sender As Object, e As EventArgs) Handles btDelete.Click
        ...
        System.Windows.Forms.Cursor.Current = Cursors.WaitCursor
        If DataGridView1.CurrentRow IsNot Nothing Then
            If MessageBox.Show("ยืนยันที่จะลบ " & DataGridView1.CurrentRow.Cells("ADDRESS_TYPE_NAME_TH").Value.ToString, "ยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                'delete it
                Dim parameters As New Dictionary(Of String, Object)
                parameters.Add("@p0", DataGridView1.CurrentRow.Cells("ADDRESS_TYPE_CODE").Value)

                Dim query As String = "DELETE FROM MB_ADDRESS_TYPE WHERE ADDRESS_TYPE_CODE = @p0"
    ...
    Private Sub btFindIndus_Click(sender As Object, e As EventArgs) Handles btFind.Click
        getMB_PRENAME()
    End Sub
End Class
